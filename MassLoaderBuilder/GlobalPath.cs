namespace MassLoaderBuilder
{
    ...
    public static class GlobalPath
    {
        ...
        GetFileName = FileManager.GetFileName(AppDomain.CurrentDomain.FriendlyName), // MassLoaderBuilder.exe
        AssemblyPath = Assembly.GetExecutingAssembly().Location; // bin\Release\MassLoaderBuilder.exe
    }
}